...
// GoldcoinRPC is an interface to JSON-RPC bitcoind service.
type GoldcoinRPC struct {
	*bchain.BaseChain
	client       http.Client
	rpcURL       string
	user         string
...
// NewGoldcoinRPC returns new GoldcoinRPC instance.
func NewGoldcoinRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
	var err error
	var c Configuration
	...
	// btc supports both calls, other coins overriding GoldcoinRPC can change this
...
// Initialize initializes GoldcoinRPC instance.
func (b *GoldcoinRPC) Initialize() error {
...
func (b *GoldcoinRPC) CreateMempool(chain bchain.BlockChain) (bchain.Mempool, error) {
	if b.Mempool == nil {
...
func (b *GoldcoinRPC) InitializeMempool(addrDescForOutpoint bchain.AddrDescForOutpointFunc, onNewTxAddr bchain.OnNewTxAddrFunc) error {
	if b.Mempool == nil {
...
func (b *GoldcoinRPC) Shutdown(ctx context.Context) error {
	if b.mq != nil {
...
func (b *GoldcoinRPC) GetCoinName() string {
	return b.ChainConfig.CoinName
}

// GetSubversion returns the backend subversion
func (b *GoldcoinRPC) GetSubversion() string {
...
func (b *GoldcoinRPC) GetBestBlockHash() (string, error) {
...
func (b *GoldcoinRPC) GetBestBlockHeight() (uint32, error) {
...
func (b *GoldcoinRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (b *GoldcoinRPC) GetBlockHash(height uint32) (string, error) {
...
func (b *GoldcoinRPC) GetBlockHeader(hash string) (*bchain.BlockHeader, error) {
...
func (b *GoldcoinRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" {
...
func (b *GoldcoinRPC) GetBlockInfo(hash string) (*bchain.BlockInfo, error) {
...
func (b *GoldcoinRPC) GetBlockWithoutHeader(hash string, height uint32) (*bchain.Block, error) {
	data, err := b.GetBlockRaw(hash)
	if err != nil {
		return nil, err
	}
...
func (b *GoldcoinRPC) GetBlockRaw(hash string) ([]byte, error) {
...
func (b *GoldcoinRPC) GetBlockFull(hash string) (*bchain.Block, error) {
...
func (b *GoldcoinRPC) GetMempoolTransactions() ([]string, error) {
...
func (b *GoldcoinRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
...
func (b *GoldcoinRPC) GetTransaction(txid string) (*bchain.Tx, error) {
...
func (b *GoldcoinRPC) GetTransactionSpecific(tx *bchain.Tx) (json.RawMessage, error) {
...
func (b *GoldcoinRPC) getRawTransaction(txid string) (json.RawMessage, error) {
...
func (b *GoldcoinRPC) EstimateSmartFee(blocks int, conservative bool) (big.Int, error) {
...
func (b *GoldcoinRPC) EstimateFee(blocks int) (big.Int, error) {
...
func (b *GoldcoinRPC) SendRawTransaction(tx string) (string, error) {
...
func (b *GoldcoinRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
...
func (b *GoldcoinRPC) Call(req interface{}, res interface{}) error {
