...
// GoldcoinParser handle
type GoldcoinParser struct {
	*bchain.BaseParser
...
// NewGoldcoinParser returns new GoldcoinParser instance
func NewGoldcoinParser(params *chaincfg.Params, c *Configuration) *GoldcoinParser {
	p := &GoldcoinParser{
...
func (p *GoldcoinParser) GetAddrDescFromVout(output *bchain.Vout) (bchain.AddressDescriptor, error) {
...
func (p *GoldcoinParser) GetAddrDescFromAddress(address string) (bchain.AddressDescriptor, error) {
	return p.addressToOutputScript(address)
}

// GetAddressesFromAddrDesc returns addresses for given address descriptor with flag if the addresses are searchable
func (p *GoldcoinParser) GetAddressesFromAddrDesc(addrDesc bchain.AddressDescriptor) ([]string, bool, error) {
	return p.OutputScriptToAddressesFunc(addrDesc)
}

// GetScriptFromAddrDesc returns output script for given address descriptor
func (p *GoldcoinParser) GetScriptFromAddrDesc(addrDesc bchain.AddressDescriptor) ([]byte, error) {
	return addrDesc, nil
}

// IsAddrDescIndexable returns true if AddressDescriptor should be added to index
// empty or OP_RETURN scripts are not indexed
func (p *GoldcoinParser) IsAddrDescIndexable(addrDesc bchain.AddressDescriptor) bool {
...
func (p *GoldcoinParser) addressToOutputScript(address string) ([]byte, error) {
...
func (p *GoldcoinParser) TryParseOPReturn(script []byte) string {
...
func (p *GoldcoinParser) tryParseOmni(data []byte) string {
...
func (p *GoldcoinParser) outputScriptToAddresses(script []byte) ([]string, bool, error) {
...
func (p *GoldcoinParser) TxFromMsgTx(t *wire.MsgTx, parseAddresses bool) bchain.Tx {
...
func (p *GoldcoinParser) ParseTx(b []byte) (*bchain.Tx, error) {
	t := wire.MsgTx{}
	r := bytes.NewReader(b)
...
func (p *GoldcoinParser) ParseBlock(b []byte) (*bchain.Block, error) {
	w := wire.MsgBlock{}
	r := bytes.NewReader(b)
...
func (p *GoldcoinParser) PackTx(tx *bchain.Tx, height uint32, blockTime int64) ([]byte, error) {
...
func (p *GoldcoinParser) UnpackTx(buf []byte) (*bchain.Tx, uint32, error) {
...
func (p *GoldcoinParser) MinimumCoinbaseConfirmations() int {
	return p.minimumCoinbaseConfirmations
}

func (p *GoldcoinParser) addrDescFromExtKey(extKey *hdkeychain.ExtendedKey) (bchain.AddressDescriptor, error) {
...
func (p *GoldcoinParser) DeriveAddressDescriptors(xpub string, change uint32, indexes []uint32) ([]bchain.AddressDescriptor, error) {
...
func (p *GoldcoinParser) DeriveAddressDescriptorsFromTo(xpub string, change uint32, fromIndex uint32, toIndex uint32) ([]bchain.AddressDescriptor, error) {
...
func (p *GoldcoinParser) DerivationBasePath(xpub string) (string, error) {
	extKey, err := hdkeychain.NewKeyFromString(xpub, p.Params.Base58CksumHasher)
	if err != nil {
		return "", err
	}
